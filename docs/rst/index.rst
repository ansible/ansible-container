...
With Ansible Container you're no longer limited by Dockerfile. You can now apply the power of Ansible to the image build
...
But Ansible Container doesn't stop there. Use Ansible Container to run the application, and push images to private and
public registries. When you're ready to deploy to the cloud, use it to generate an Ansible role that automates the
deployment.
